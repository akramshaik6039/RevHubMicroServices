package com.revhub.feed.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ChatMessageEvent> consumerFactory() {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "feed-service-group");
        config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, ChatMessageEvent.class);
